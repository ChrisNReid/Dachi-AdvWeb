...
const JWT_SECRET = 'TlJ2sQP1bhiEIqYXTFaS/LV/MQTtC9DUX4WLqKwkJ9X3uYGAfJhId7ZLq0HdNyPsmvo831W7/4pZDa1Bw1YCsQ=='
...
app.post('/api/signup',async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({ message: 'Sign up successful.', user, token });
